...
import (
	"fmt"
	"github.com/chiuwah/fd_users-api/datasources/mysql/users_db"
	"github.com/chiuwah/fd_users-api/logger"
	"github.com/chiuwah/fd_users-api/utils/errors"
	"github.com/chiuwah/fd_users-api/utils/mysql_utils"
	"strings"
)
...
func (user *User) Save() *errors.RestErr {
	...
	if err != nil {
		logger.Error("error when trying to get LastInsertId", err)
		return errors.NewInternalServerError("database error")
	}
	user.Id = userId
	return nil
